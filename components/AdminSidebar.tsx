...
const NAV = [
  ...
  { href: '/admin/salon', label: 'Cotizaciones salón', icon: PartyPopper },
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-56 bg-lago-950 text-white flex flex-col min-h-screen flex-shrink-0">
      <div className="p-5 border-b border-lago-800">
        <p className="font-display text-sm text-white font-light">Cabañas</p>
